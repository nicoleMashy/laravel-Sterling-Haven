...
<div class="main-wrapper">
    ...
    <section id="main" role="main"><div class="container " >
            <h2 style="text-align:center"><strong>Sterling Haven toilet cleaner</strong></h2>
        </div>
        <div class="container " >
                            ...
                            <div class="flip-card">
                                <div class="flip-card-inner">
                                    <div class="flip-card-front">
                                        <img src="/images/toilet.png" alt="Avatar" style="width:300px;height:300px;">
                                    </div>
                                    <div class="flip-card-back">
                                        <h1>one toilet cleaner</h1>
                                        <p>dish wash</p>
                                        <p>sterling haven</p>
                                    </div></div></div></div>
                        <div class="flip-card">
                            <div class="flip-card-inner">
                                ...
                                <div class="flip-card-back">
                                    <h1>sterling haven</h1>
                                    <p>best toilet clener</p>
                                    <p>We love it</p>
            ...
            <div class="rowan">
                <div class="columbia" style="background-color:white;">
                    <h2>how to use</h2>
                    <p>1. Some text.ghjkljdc[dfpoiufsfd[v.</p>
                    <p>1. Some text.ghjkljdc[dfpoiufsfd[v.</p>
                    <p>1. Some text.ghjkljdc[dfpoiufsfd[v.</p>
                    <p>1. Some text.ghjkljdc[dfpoiufsfd[v.</p>
                </div>
