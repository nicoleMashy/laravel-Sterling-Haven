...
<div class="main-wrapper">
    ...
    <section id="main" role="main"><div class="container " >
            <h2 style="text-align:center"><strong>Sterling Haven  Washing powder</strong></h2>
        </div>
        <div class="container " >
                            ...
                            <div class="flip-card">
                                <div class="flip-card-inner">
                                    <div class="flip-card-front">
                                        <img src="/images/powder.png" alt="Avatar" style="width:300px;height:300px;">
                                    </div>
