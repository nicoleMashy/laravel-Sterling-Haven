...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/css/wash.css') }}" type="text/css">
...
<div class="main-wrapper">
    ...
    <div class="navbar ">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="{{ url('company') }}">sterling haven</a>
                <a href="{{ url('products') }}">products</a>
    ...
    <section id="main" role="main">
        <h2 style="text-align:center"><strong> get in touch with us @Sterling Haven </strong></h2>
        <div class="container "  style="height: 400px  ; background-color: white;">

            <div class="rowan">
                <div class="columbia" style="background-color:white;">
                    <h2>call us</h2>
                    <img src="/images/clean.png" alt="Avatar" style="width:300px;height:300px; border-radius:25px;">

                </div>
                <div class="columbia" style="background-color:white;">
                    <h2>sterling Haven Adrress</h2>
                    <p>1. Some text.ghjklzcjx[c;zlkczh j kc.</p>
                    <p>1. Some text.ghjklzcjx[c;zlkczh j kc.</p>
                    <p>1. Some text.ghjklzcjx[c;zlkczh j kc.</p>
                    <h2>our company</h2>
                    <p>1. Some text.ghjklzcjx[c;zlkczh j kc.</p>
                    ...
                    <h1>sterling harven @ social media sites</h1>
                    <p> <a href="#"><i class="fa fa-twitter " style="font-size:60px; "></i></a><a href="#"> <i class="fa fa-linkedin " style="font-size:60px;"></i> </a> <a href="#" ><i class="fa fa-instagram "  style="font-size:60px;"></i> </a> <a href="#" ><i class="fa fa-facebook "  style="font-size:60px;"></i></a></p>
        ...
        <div class="container "  style="height: 400px  ; background-color: white;">
            <div class="rowan">
                ...
                <div class="columbia" style="background-color:white;">
                    <h2>locate us</h2>
                    <img src="/images/map.png" alt="Avatar" style="width:300px;height:300px; ">
